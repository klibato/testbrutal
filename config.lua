Config = {
    ...
    ProgressBar = 'mythic_progbar', -- 'progressBars' / 'pogressBar' / 'mythic_progbar' // Custom can be add in the cl_utils.lua!!!
    ...
    PoliceStations = {
        ...
        ['Police Department'] = {
            ...
            Blip = {color = 38, sprite = 60, size = 0.6}, -- Job blip
            Marker = {use = true, marker = 20, rgb = {15, 100, 210}, bobUpAndDown = true, rotate = false},
            
            Duty = vector3(608.0304, 1.0756, 82.7600), -- Duty ON / OFF coords
            ...
            Garages = {
                {
                    ...
                    menu = vector3(528.3946, 30.5107, 69.5110), -- Garage menu open coords
                    spawn = vector4(527.0367, 35.6097, 69.5110, 211.5390), -- Vehicle spawn coords
                    deposit = vector3(527.0367, 35.6097, 69.5110), -- Vehicle deposit place
                    ...
                    vehicles = {
                        ...
                        ['poltorencer'] = {
                            Label = 'Polizei rencer',
                            minRank = 4
                        },
        
                        ['polalamor'] = {
                            Label = 'Polizei Declase',
                            minRank = 1
                        },
						
						['police4'] = {
                            Label = 'Polizei Undercover',
                            minRank = 4
                        },
						
						['polbuffalor'] = {
                            Label = 'Polizei Buffalo',
                            minRank = 4
                        },
						['polfugitiver'] = {
                            Label = 'Polizei Fugitiver',
                            minRank = 1 
                        },
						['polscoutr'] = {
                            Label = 'Polizei Scout',
						...
						['polspeedo'] = {
                            Label = 'Gefängnistransporter klein',
                            minRank = 1
                        },
        ...
        ['Sheriff Department'] = {
            ...
            Blip = {color = 22, sprite = 60, size = 0.6}, -- Job blip
            Marker = {use = true, marker = 20, rgb = {15, 100, 210}, bobUpAndDown = true, rotate = false},
            
            Duty = vector3(1832.1400, 3680.3828, 34.3261), -- Duty ON / OFF coords
            DutyBlips = true, -- With this the cops can see the other cops in the map.
            ...
            Garages = {
                {
                    Label = 'Garage I.', -- Gargae Label
                    menu = vector3(1826.3181, 3671.2700, 34.1864), -- Garage menu open coords
                    spawn = vector4(1822.9139, 3671.4678, 34.1864, 23.3853), -- Vehicle spawn coords
                    deposit = vector3(1822.9139, 3671.4678, 34.1864), -- Vehicle deposit place
                    ...
                    vehicles = {
						...
						['bcsofugitive'] = {
                            Label = 'Sheriff gitive',
                            minRank = 5
                        },
						
						['bcsogranger'] = {
                            Label = 'Sheriff Ranger',
                            minRank = 1
                        },
						
						['bcsogranger2'] = {
                            Label = 'Sheriff Ranger2',
                            minRank = 1
                        },
						
						['bcsogranger3'] = {
                            Label = 'Sheriff Ranger3',
                            minRank = 1
                        },
						
						['bcsosandking'] = {
                            Label = 'Sheriff Sandking',
                            minRank = 3
                        },
						...
						['bcsostanier'] = {
                            Label = 'Sheriff Stainer',
                            minRank = 1
                        },
						
						['bcsostanier2'] = {
                            Label = 'Sheriff Scout2',
                            minRank = 5
                        },
                    }
                },
    ...
    Commands = {
        ...
        JobMenu = {
            ...
            Suggestion = 'Jobmenü öffnen'
        },

        MDT = {
            Command = 'mdt', 
            Suggestion = 'MDT-Menü öffnen'
        },

        VehiclePanel = {
            Command = 'vehiclepanel',
            Suggestion = 'Bearbeiten der Fahrzeugtafelposition'
        },

        PlateReader = {
            WhitelistedVehicles = {'police', 'police2', 'police3', 'police4', 'fbi', 'fbi2', 'sheriff', 'sheriff2', 'dexbuff18', 'polstanierr', 'polstalkerr', 'polscoutr', 'polfugitiver', 'policeslick', 'polbuffalor', 'polalamor', 'polspeedo', 'poltorencer', 'pscoutnew'}, -- false =  not in use
            Command = 'platereader', 
            Control = 'F4',  -- Controls list:  https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/
            Suggestion = 'Nummernschield Reader-Menü'
        },

        AreaLock = {
            Command = 'arealock', 
            Suggestion = 'Bereichssperrmenü'
        },

        CameraRepair = {
            Command = 'camera_repair', 
            Suggestion = 'Reparieren Sie die Kamera'
        },

        Drag = {
            Command = 'drag', 
            Suggestion = 'Animation ziehen'
        },

        RemoveObjects = {
            Command = 'removeobjects', 
            Suggestion = 'Objekte entfernen'
        },
    ...
    Prison = {
        ...
        Hospital = {
            Blip = {label = 'Gefängniskrankenhaus', coords = vector3(1767.7861, 2570.3118, 45.7299), color = 2, sprite = 61, size = 0.6}, 
        ...
        Shop = {
            Blip = {label = 'Gefängnisladen', color = 69, sprite = 59, size = 0.6}, 
            Coords = vector3(1779.9288, 2559.0132, 45.6731),
            Items = {
                -- In ESX
                {item = 'burger', label = 'Burger', price = 1},
                {item = 'water', label = 'Wasser', price = 1},

                -- In QB
                --{item = 'sandwich', label = 'Sandwich', price = 1},
                --{item = 'water_bottle', label = 'Wasser', price = 1},
            }
        },

        Jobs = {
            Use = true,
            Blip = {label = 'Gefängnisjob', color = 17, sprite = 66, size = 0.6},
            ...
            Works = {
                -- Welding
                {
                    ...
                    Blip = {label = 'Arbeitsposition', color = 26, sprite = 354, size = 0.8},
                ...
                -- Hammering
                {
                    ...
                    Blip = {label = 'Arbeitsposition', color = 26, sprite = 402, size = 0.6},
                ...
                -- Planting
                {
                    Time = 10,
                    Money = {min = 100, max = 200},
                    Blip = {label = 'Arbeitsposition', color = 2, sprite = 1, size = 0.6},
                ...
                -- Cleaning
                {
                    Time = 10,
                    Money = {min = 100, max = 200},
                    Blip = {label = 'Arbeitsposition', color = 5, sprite = 1, size = 0.6},
    ...
    Locales = {
        CameraLabel = 'Links ~INPUT_CELLPHONE_LEFT~ Rechts ~INPUT_CELLPHONE_RIGHT~\nHoch  ~INPUT_CELLPHONE_UP~ Runter ~INPUT_CELLPHONE_DOWN~\n~r~Cancel ~INPUT_CELLPHONE_CANCEL~',
        ObjectLabel = 'Objekt drehen ~INPUT_CELLPHONE_LEFT~ & ~INPUT_CELLPHONE_RIGHT~\n~b~Objekt platzieren~w~ ~INPUT_FRONTEND_RDOWN~',
        Male = 'Mann',
        Female = 'Frau',
        ...
        Uncuff = 'Entfesseln',
        Drag = 'Mitnehmen',
        InOutOfVehicle = 'Ein- und Aussteigen aus dem Fahrzeug',

        VehicleInteractions = 'Fahrzeuginteraktionen',
        Lockpick = 'Dietrich',
        WheelClamp = 'Autokralle',
        Impound = 'Beschlagnahmen',
        VehicleSearch = 'Durchsuchen',
    ...
    Texts = {
        [1] = {'[E] - Um das Kleidermenü zu öffnen', 38},
    ...
    Progressbar = {
        DutyOFF = 'Dienstende OFF...',
        DutyON = 'Dienstbeginn ON...',
        Working = 'Arbeiten...',
        WheelClampPlacing = 'Radklemme anbringen...',
        Impound = 'Beschlagnahmen...'
    },
